...
def make_fisheries_widget():
    ...
    param_labs = ['a: disponibilidade de presas', 'b: taxa de crescimento da presa', 'c: taxa de conversão de presa->predador', 'd: taxa de mortalidade do predador', 
			'h: tempo para consumir a presa', 'K: capacidade de carga da presa', 'm: taxa interferência do predador', 'z: fração de presas colhida']
